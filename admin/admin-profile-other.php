			...
			<?php
				if(isset($_GET['roll'])){
					...
					if(strcmp($r,"")==0&&strcmp($m,"")==0){
						...
						$query1=mysqli_query($connection,"select * from other_due where roll_number='$r' and added_by='$m' order by added_on");	
					}
					else if(strcmp($m,"")!=0){
						$query1=mysqli_query($connection,"select * from other_due where added_by='$m' order by roll_number");
					}
					else{
						$query1 = mysqli_query($connection,"select * from other_due where roll_number='$r' order by added_on");
					}
				}
				else{
					$query1=mysqli_query($connection,"select * from other_due order by roll_number");	
